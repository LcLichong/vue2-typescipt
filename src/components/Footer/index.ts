...
import { FooterList, Menu } from "../../type/footer-type";
import "./index.less";
...
export default class Footer extends Vue {
  ...
  getFooter(): Array<VNode> {
    ...
    const getMenu = (menuList: Array<Menu>): Array<VNode> => {
      const menuArray = [];
      ...
      const vnode = h(
        ...
        [
          ...
          h(
            ...
            {
              class: `${
                this.idx === f.idx ? "cs-footer-menu-active" : ""
              } cs-footer-menu`,
            },
            [...getMenu(f.menuList)]
          ),
